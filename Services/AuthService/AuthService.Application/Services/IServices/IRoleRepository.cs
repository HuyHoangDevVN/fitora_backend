...
public interface IRoleRepository
{
    ...
    Task<object> GetRoleByIdAsync(string id, CancellationToken cancellationToken = default!);
    Task<bool> AssignRolesAsync(AssignRoleRequestDto dto, CancellationToken cancellationToken = default!);
    Task<bool> RemoveRolesAsync(AssignRoleRequestDto dto, CancellationToken cancellationToken = default!);
